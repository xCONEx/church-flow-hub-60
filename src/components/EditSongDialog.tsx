...
interface EditSongDialogProps {
  ...
  song: any;
  onSongUpdated: (songId: string, updatedSong: any) => void;
}
...
export const EditSongDialog = ({ trigger, song, onSongUpdated }: EditSongDialogProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSongUpdated(song.id, updatedSong);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Editar Música - {song.title}</DialogTitle>
        </DialogHeader>
