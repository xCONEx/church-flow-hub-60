...
export const EditMemberDialog = ({ trigger, member, onEdit }: EditMemberDialogProps) => {
  ...
  const getExperienceValue = () => {
    const exp = typeof member?.experience === 'number' ? member.experience : 3;
    if (exp <= 3) return 'beginner';
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setFormData(prev => ({ 
                    ...prev, 
                    experience: value,
                    experienceLevel: getExperienceLevel(value)
                  }))}
                >
                  <SelectTrigger>
                    <SelectValue />
